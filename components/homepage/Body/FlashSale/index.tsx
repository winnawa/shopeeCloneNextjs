...
export const paintingArray= [
    ...
    },
    {
        ...
        salePercent : "5%",
        description  : "The child is being held by her mother and older sister. The mother grips the child firmly, the sister more hesitantly, and Rembrandt observes her looking at the childs face to see how anxious she is. The lines of her shoulders beautifully indicate this; Rembrandt even turned his pen round and scratched through the ink to emphasise it. It makes me see the childs face, a hint of worry in it, indicated only by one or two faint marks. One then begins to look at ink, not mothers and sisters, and marks made by a hand, speedily. The trace of Rembrandts hand is still alive. Your eye can go back and forth between brown ink: sister; fast mark: mother. How rewarding this is, to move from the physical surface of the paper to its disappearance when you read the subject, and then back again. How many marvellous layers does this drawing have? The mother has a double profile, Picassoesque. Was it an accident with the pen that he then used as a master would? Both profiles are fascinating about her character. Her skirt is a bit ragged, without any real detail; one seems to know this, and then marvels at how these few lines suggest it. Then, theres a passing milkmaid, perhaps glancing at a very common scene, and we know the milk pail is full. You can sense the weight. Rembrandt perfectly and economically indicates this with what? Six marks, the ones indicating her outstretched arm. Very few people could get near this. It is a perfect drawing.",
    },
    {
        ...
        salePercent : "40%",
        description:"This impressive study of an unknown woman is one of Rubenss finest drawings. He used red chalk for the face, neck and hands, and black chalk for the clothes. The face with the slghtly open mouth is drawn three-quarter view. Evidently Rubens was extremely pleased with this study as he used it in several paintings, including The Crowning of St Catherine, his altar piece of 1631 (Toledo Museum of Art, Ohio).",
    },
    {   
    ...
    },
    {
        ...
        salePercent : "25%",
        description  :  "The Pieta is regarded as one of the greatest works of the Renaissance artist Michelangelo Buonarroti. This impressive sculpture is currently placed in Vatican City, at St. Peters Basilica. The Pieta is among the initial works of art of the similar theme made by the artist. Cardinal Jean de Billheres commissioned the statue, and this nobleman was a previous representative in Rome. The statue, which was in Carrara marble, was created to the funeral monument of the cardinal, yet it was relocated at St. Peters Basilica during the 18th century. It was also the only artwork by Michelangelo that was signed by the artist himself."
    },
    {
        name : "The Kiss",
        price: "112000$",
    ...
    },
    {
        ...
        salePercent : "50%",
        description : "This artwork is a portrait of James McNeill Whistlers mother, Anna McNeill Whistler while they were in London in 1871. It was said that James model was not able to commit to the job and it was during this time that James decided to do his mothers portrait. There was a lot of experimentation before the creation of this famous painting. James Whistler wanted his mother to pose for him while standing up but it proved to be too tiresome for her. It was in this painting that Whistler was able to express his style in tonal composition and harmony. At first glance the painting appears simple. However, upon closer inspection the artwork indeed portrays a balance between the different shapes in the picture.",
